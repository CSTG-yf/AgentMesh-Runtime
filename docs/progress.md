...
| 20 | Quicksort abbreviation routing: `快排` and self-built examples trigger Executor CodeAct with visible input/sorted output | Completed | `tests/test_dynamic_agent_routing.py::test_protocol_mode_executes_chinese_quick_sort_abbreviation_with_self_test` |
